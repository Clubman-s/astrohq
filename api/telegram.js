...
const TELEGRAM\_TOKEN = process.env.TELEGRAM\_TOKEN;
const OPENAI\_KEY = process.env.OPENAI\_KEY;
...
const openai = new OpenAI({ apiKey: OPENAI\_KEY });
const bot = new TelegramBot(TELEGRAM\_TOKEN, { polling: false });
